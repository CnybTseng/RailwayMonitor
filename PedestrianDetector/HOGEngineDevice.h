...
extern "C" __host__ void CalculateHOGDescriptor(float *hostImage, int width, int height, int noOfHistogramBins,
                                                int windowSizeX, int windowSizeY, int cellSizeX, int cellSizeY,
                                                int blockSizeX, int blockSizeY, float *hostDesc, float *gradient);

extern "C" __host__ void InitHOGDescriptorCalculator(int width, int height, int noOfHistogramBins,
                                                     int windowSizeX, int windowSizeY, int cellSizeX, int cellSizeY,
                                                     int blockSizeX, int blockSizeY, float wtscale);

extern "C" __host__ void HOGDescriptorCalculator(float *hostImage, float *hostDesc);

extern "C" __host__ void HOGDescriptorCalculatorOG(float *hostImage, float *hostDesc, float *gradient);

extern "C" __host__ void FreeHOGDescriptorCalculator();													 
...
extern "C" __host__ void GetHOGDescriptor(float *hostDesc);
